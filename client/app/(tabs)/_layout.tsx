    ...
    <>
      <Tabs
        screenOptions={{
          ...
          tabBarStyle: {
            borderColor: themeValue === "dark" ? colors.slate["500"] : colors.slate["200"],
            backgroundColor: themeValue === "dark" ? colors.slate["900"] : colors.slate["100"]
          }
        }}>
        {
          [{
              ...
              headerRight: () => (
                <View style={tw`flex-row gap-2 px-4`}>
                  <TouchableOpacity activeOpacity={.8} style={tw`rounded-full p-2`}>
                    <Pencil size={20} style={tw`text-slate-700 dark:text-slate-200`} />
                  </TouchableOpacity>
                  <TouchableOpacity activeOpacity={.8} style={tw`rounded-full p-2`}>
          ...
          },
          {
            ...
            <Tabs.Screen
              ...
              options={{
                ...
                tabBarIcon: ({ focused }) => screen.icon({
                  focused
                }),
              }}
            />
