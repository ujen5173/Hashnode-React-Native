  ...
  return (
    <View style={tw`flex-1 items-center justify-center bg-slate-900`}>
      ...
      <View style={tw`mb-12 w-11/12`}>
        <Text style={tw`text-slate-200 text-xl text-center font-bold`}>Create an account or</Text>
        <Text style={tw`text-slate-200 text-xl text-center font-bold`}>Sign in to your Hashnode Account</Text>
      </View>

      <View style={tw`w-full mb-24`}>
        <Text style={tw`text-slate-200 text-center mb-2 text-lg`}>Sign in with email address</Text>
      ...
      <View>
        <Text style={tw`text-slate-300 text-center text-base font-semibold mb-2`}>or sign in with</Text>
